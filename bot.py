...
# --- НАЧАЛО НОВОГО БЛОКА ДЛЯ RENDER (WEBHOOK) ---
from flask import Flask, request
from threading import Thread

# Создаем Flask-приложение для обработки веб-хуков от Telegram
...
def start_webhook_server():
    """Запускает сервер для приема веб-хуков."""
...
print(f"Настройка веб-хука на URL: {WEBHOOK_URL}")
